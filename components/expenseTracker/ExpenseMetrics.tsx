...
const ExpenseMetrics = ({
  ...
  // Use 'as const' to assert the type of keys in categoryCounts
  type CategoryKey = keyof typeof categoryCounts;

  const topCategory = (Object.keys(mostCommonCategory) as CategoryKey[]).reduce(
    (a, b) => (mostCommonCategory[a] > mostCommonCategory[b] ? a : b)
  );
  ...
  const formatter = useMemo(
    () =>
      new Intl.NumberFormat("en-IN", {
        style: "currency",
        currency: "INR", // Default to INR since preferredCurrency is removed
      ...
      <MetricCard
        ...
        subtext={
          <div className="flex gap-2 items-center">
            ...
            {highestExpense.category.toUpperCase()} {/* Changed from topCategory to highestExpense.category */}
          </div>
        }
        formatter={formatter}
        bgColor="bg-red-50"
