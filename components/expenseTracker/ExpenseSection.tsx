...
const ExpenseSection = ({planId}: {planId: string}) => {
  ...
  // Transform the data to include `whoSpent`
  const transformedData = data.map(expense => ({
    ...expense,
    whoSpent: expense.userId, // Assuming userId is the one representing who spent the money
  }));
  ...
  return (
    <>
      ...
      <ExpenseMetrics expenses={transformedData} />
