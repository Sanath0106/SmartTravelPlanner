...
const Banner = () => {
  return (
    ...
    >
      ...
      text-left w-full"
        >
          Explore the <br /> <span className="text-blue-500">AI</span> Travel{" "}
            ...
            <p
              className="mt-5 mb-5
                      ...
                      text-muted-foreground
                        ...
                        text-left"
            >
              Say goodbye to endless hours of research and planning. Experience the AI Travel Plan and enjoy effortless travel.
              Our AI does the heavy lifting,so you can focus on making memories.
            </p>
          </div>
        </div>
